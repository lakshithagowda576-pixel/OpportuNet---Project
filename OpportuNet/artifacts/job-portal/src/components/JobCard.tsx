...
export function JobCard({ job, applicantCount }: JobCardProps) {
  ...
  return (
    <div className="group bg-card rounded-2xl p-6 border border-border shadow-sm hover:shadow-2xl hover:border-primary/30 hover:-translate-y-1 transition-all duration-300 transform-gpu flex flex-col h-full relative overflow-hidden">
