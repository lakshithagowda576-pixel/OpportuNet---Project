      ...
      >
        ...
        <div className="relative z-10 p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="max-w-2xl text-primary-foreground space-y-4">
            <p className="text-sm uppercase tracking-[0.3em] text-primary-foreground/75">Welcome back{user?.name ? `, ${user.name.split(" ")[0]}` : ""}</p>
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat, index) => (
          ...
          >
            ...
            <h3 className="text-3xl font-display font-bold text-foreground mb-1"><AnimatedNumber value={stat.value} /></h3>
